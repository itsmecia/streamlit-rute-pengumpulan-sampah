...
[data-testid="stSidebar"] { 
    background: linear-gradient(to bottom right, #B4CBB4, #DDECE0);
...
#header
st.markdown("<h2 style='font-weight:bold; text-align:center;'>♻️ Analisis Rute & Pengumpulan Sampah</h2>", unsafe_allow_html=True)
st.markdown(
...
# TREN VOLUME SAMPAH 
    ...
    if "nearest_tpa" in tps_df.columns:
        ...
        st.markdown("#### Rata-rata keterisian per TPA")
        st.dataframe(
